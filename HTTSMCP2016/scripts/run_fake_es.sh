...
combineTool.py -M T2W -i output/fake_es/{htt_mt_1_13TeV,htt_mt_2_13TeV}/* -o ws.root --parallel 8
...
python scripts/plot1DScanFakeES.py --main=output/fake_es/htt_mt_1_13TeV/higgsCombine.dm0.MultiDimFit.mH125.root --POI=faketaues --output=mu_dm0_fit --improve

#combineTool.py -m 125 -M MultiDimFit --redefineSignalPOIs=faketaues --setPhysicsModelParameterRanges faketaues=984,1050 --points 50 -d output/fake_es/htt_mt_1_13TeV/ws.root --algo none --there -n .dm0.plot --preFitValue 1000 --saveFitResult
...
python scripts/postFitPlot.py --file=shapes_mu_dm0.root --ratio --no_signal --file_dir="htt_mt_1_" --ratio_range 0.7,1.3 --outname mu_dm0 --mode postfit --esplot --y_title="dN/dm_{#mu#tau} (1/GeV)" --x_title="m_{#mu#tau} (GeV)" --channel_label="#mu#tau_{h} 1-prong 0-#pi^{0}"
...
python scripts/postFitPlot.py --file=shapes_mu_dm0_es1.root --ratio --no_signal --file_dir="htt_mt_1_" --ratio_range 0.7,1.3 --outname mu_dm0 --mode prefit --esplot --y_title="dN/dm_{#mu#tau} (1/GeV)" --x_title="m_{#mu#tau} (GeV)" --channel_label="#mu#tau_{h} 1-prong 0-#pi^{0}"
...
python scripts/plot1DScanFakeES.py --main=output/fake_es/htt_mt_2_13TeV/higgsCombine.dm1.MultiDimFit.mH125.root --POI=faketaues --output=mu_dm1_fit --improve
...
python scripts/postFitPlot.py --file=shapes_mu_dm1.root --ratio --no_signal --file_dir="htt_mt_2_" --ratio_range 0.7,1.3 --outname mu_dm1 --mode postfit --esplot --y_title="dN/dm_{#mu#tau} (1/GeV)" --x_title="m_{#mu#tau} (GeV)" --channel_label="#mu#tau_{h} 1-prong 1-#pi^{0}"
