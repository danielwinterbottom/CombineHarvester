...
/*  cb.cp().process({"TTH_SM125"}).AddSyst(cb, "pdf_Higgs_ttH","lnN",
 ...
 //     ({"et","mt","tt"}, {9,11}, {"3200"}, 0.98));
  ...
  cb.cp().process({"bbH-NLO"}).AddSyst(cb, "Qsh_bbH","lnN", SystMap<channel,bin_id,mass>::init
      ({"et","mt","tt"}, {8,10}, {"130"}, 1.03)
      ({"et","mt","tt"}, {9,11}, {"130"}, 0.92)
      ({"et","mt","tt"}, {8,10}, {"200"}, 1.03)
      ({"et","mt","tt"}, {9,11}, {"200"}, 0.93) 
      ({"et","mt","tt"}, {8,10}, {"350"}, 1.03)
      ({"et","mt","tt"}, {9,11}, {"350"}, 0.94)
      ({"et","mt","tt"}, {8,10}, {"700"}, 1.03)
      ({"et","mt","tt"}, {9,11}, {"700"}, 0.97)
      ({"et","mt","tt"}, {8,10}, {"1200"}, 1.02)
      ({"et","mt","tt"}, {9,11}, {"1200"}, 0.99)
      ({"et","mt","tt"}, {8,10}, {"1800"}, 1.02)
      ({"et","mt","tt"}, {9,11}, {"1800"}, 0.99)
      ({"et","mt","tt"}, {8,10}, {"3200"}, 1.01)
      ({"et","mt","tt"}, {9,11}, {"3200"}, 0.99));
 ...
 // cb.cp().process({"bbH-NLO"}).AddSyst(cb, "Qsh_bbH","lnN", SystMap<channel,bin_id,mass>::init
 //     ({"et","mt","tt"}, {8,10}, {"130"}, 1.03)
 //     ({"et","mt","tt"}, {9,11}, {"130"}, 1.06)
 //     ({"et","mt","tt"}, {8,10}, {"200"}, 1.03)
 //     ({"et","mt","tt"}, {9,11}, {"200"}, 1.05) 
 //     ({"et","mt","tt"}, {8,10}, {"350"}, 1.03)
 //     ({"et","mt","tt"}, {9,11}, {"350"}, 1.06)
 //     ({"et","mt","tt"}, {8,10}, {"700"}, 1.03)
 //     ({"et","mt","tt"}, {9,11}, {"700"}, 1.06)
 //     ({"et","mt","tt"}, {8,10}, {"1200"}, 1.02)
 //     ({"et","mt","tt"}, {9,11}, {"1200"}, 1.05)
 //     ({"et","mt","tt"}, {8,10}, {"1800"}, 1.02)
 //     ({"et","mt","tt"}, {9,11}, {"1800"}, 1.05)
 //     ({"et","mt","tt"}, {8,10}, {"3200"}, 1.01)
 //     ({"et","mt","tt"}, {9,11}, {"3200"}, 1.03));
